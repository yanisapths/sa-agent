---
name: frontend
description: Aster Web frontend conventions — Next.js App Router layout, feature-module boundaries, TypeScript strictness, TanStack Query and React Hook Form rules, design-system and Tailwind usage, accessibility, bundle discipline, and the definition of done. Use when writing or reviewing frontend code, planning a UI change, or checking a component against the project's conventions.
---

# Aster Web Frontend Conventions

This document defines the conventions for developing and reviewing the Aster Web frontend. It is written for the
current repository rather than as a generic React template.
...
refer: https://ktbinnovation.atlassian.net/wiki/spaces/Aster/pages/5665226839/Aster+Web+Frontend+Conventions
